...
model to calcualte mpg and then interpret the infulence onf transmission being
...
* Fit a linear regression model combination of variables as identified above
...
* The model also indicates that automatics transmission vehicles (`am==0`) 
...
mpg. Analysis of residuals is shown in ***Figure 3***. This model is still not safe
